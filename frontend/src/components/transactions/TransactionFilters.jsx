        ...
        <div className="transaction-filters-row">
            <div className="filters-group">
                <div className="filter-dropdown">
                    ...
                    <select className="filter-select" value={dateFilter} onChange={(e) => onDateFilterChange(e.target.value)}>
                ...
                <div className="filter-dropdown">
                    ...
                    <select className="filter-select" value={categoryFilter} onChange={(e) => onCategoryFilterChange(e.target.value)}>
